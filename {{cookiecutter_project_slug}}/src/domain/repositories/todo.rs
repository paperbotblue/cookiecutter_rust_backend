use crate::domain::models::todo::{CreateTodo, UpdateTodo, Todo};
...
pub trait TodoRepository: Send + Sync {
    ...
    async fn update(&self, update_todo: &UpdateTodo) -> RepositoryResult<Todo>;
    async fn list(&self, params: TodoQueryParams) -> RepositoryResult<ResultPaging<Todo>>;
    async fn get(&self, todo_id: Uuid) -> RepositoryResult<Todo>;
    async fn delete(&self, todo_id: Uuid) -> RepositoryResult<()>;
}
